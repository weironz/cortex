...
### 基线数字（HashEmbedder，加弃权阈值后）

整体 R@1 0.490 · R@5 0.775 · R@10 0.835 · MRR 0.648 · gold 均名次 4.15
误召@5 0.296 · 平均注入 31.0

分题型 R@5：专名精确 0.920 · 关系推理 0.900 · 跨域 0.900 ·
中文语义 0.690 · **时间回放 0.417**

> 真实向量（bge-m3）已接入，此基线需整体重跑——上述数字里向量那一路
> 当时**没有语义能力**（对跨语言同义词的打分是 0.0000，与无关内容相同）。
